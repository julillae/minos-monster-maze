...
Texture Simple::enemy_texture;

bool Simple::init(vec2 initialPosition)
{
	printf("Making a simple enemy\n");
...
bool Simple::set_texture(const char* texturePath)
{
	printf("Setting texture for simple enemy\n");
...
{
    printf("Setting bound for simple enemy\n");
    stopBound = bound;
}

void Simple::reset_position()
{
	m_position = m_initialPosition;
}

vec2 Simple::get_bounding_box()const
{
